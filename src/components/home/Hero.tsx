...
function EnergyCanvas() {
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < particleCount; i++) {
      ...
      if (t < 0.50)      c.setRGB(0.05, 0.45 + Math.random()*0.20, 0.12); // vert forêt
      else if (t < 0.78) c.setRGB(0.65 + Math.random()*0.15, 0.48 + Math.random()*0.12, 0.03); // or chaud
      else               c.setRGB(0.04, 0.55 + Math.random()*0.20, 0.22); // vert émeraude
